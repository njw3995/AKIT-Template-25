...
public class FieldConstants {
    ...
    switch (side) {
      case LEFT -> {
        switch (face) {
            /* Red */
          case 0 -> {
            ff = LEFT_BLUE_BRANCH_A;
          } // A
          case 5 -> {
            ff = LEFT_BLUE_BRANCH_C;
          } // C
          case 4 -> {
            ff = LEFT_BLUE_BRANCH_E;
          } // E
          case 3 -> {
            ff = LEFT_BLUE_BRANCH_G;
          } // G
          case 2 -> {
            ff = LEFT_BLUE_BRANCH_I;
          } // I
          case 1 -> {
            ff = LEFT_BLUE_BRANCH_K;
          } // K
            /* Blue */
          case 6 -> {
            ff = LEFT_RED_BRANCH_A;
          } // A
          case 11 -> {
            ff = LEFT_RED_BRANCH_C;
          } // C
          case 10 -> {
            ff = LEFT_RED_BRANCH_E;
          } // E
          case 9 -> {
            ff = LEFT_RED_BRANCH_G;
          } // G
          case 8 -> {
            ff = LEFT_RED_BRANCH_I;
          } // I
          case 7 -> {
            ff = LEFT_RED_BRANCH_K;
          } // K
          default -> {
            ff = 0;
          }
      ...
      case RIGHT -> {
        switch (face) {
            /* Red */
          case 0 -> {
            ff = RIGHT_BLUE_BRANCH_B;
          } // B
          case 5 -> {
            ff = RIGHT_BLUE_BRANCH_D;
          } // D
          case 4 -> {
            ff = RIGHT_BLUE_BRANCH_F;
          } // F
          case 3 -> {
            ff = RIGHT_BLUE_BRANCH_H;
          } // H
          case 2 -> {
            ff = RIGHT_BLUE_BRANCH_J;
          } // J
          case 1 -> {
            ff = RIGHT_BLUE_BRANCH_L;
          } // L
            /* Blue */
          case 6 -> {
            ff = RIGHT_RED_BRANCH_B;
          } // B
          case 11 -> {
            ff = RIGHT_RED_BRANCH_D;
          } // D
          case 10 -> {
            ff = RIGHT_RED_BRANCH_F;
          } // F
          case 9 -> {
            ff = RIGHT_RED_BRANCH_H;
          } // H
          case 8 -> {
            ff = RIGHT_RED_BRANCH_J;
          } // J
          case 7 -> {
            ff = RIGHT_RED_BRANCH_L;
          } // L
          default -> {
            ff = 0;
          }
                              ...
                              new Transform2d(
                                  ...
                                  adjustY
                                      + Units.inchesToMeters(
                                          getBranchFudgeFactor(face, ReefSide.RIGHT)),
                                  new Rotation2d()))
                          .getX(),
                      poseDirection
                          .transformBy(
                      ...
                      poseDirection
                          .transformBy(
                              new Transform2d(
                                  ...
                                  -adjustY
                                      + Units.inchesToMeters(
                                          getBranchFudgeFactor(face, ReefSide.LEFT)),
                                  new Rotation2d()))
                          .getX(),
                      poseDirection
                          .transformBy(
  ...
  public static boolean isAlgaeHigh(Pose2d currentPose) {
    ...
    return (nearestReefRotation.equals(new Rotation2d(0))
        || nearestReefRotation.equals(new Rotation2d(Math.toRadians(120)))
        || nearestReefRotation.equals(new Rotation2d(Math.toRadians(-120))));
  }
  ...
  public static ReefSide getNearestReefSide(Pose2d robotPose) {
    return robotPose.minus(getNearestReefFace(robotPose)).getX() < 0
        ? ReefSide.LEFT
        : ReefSide.RIGHT;
  }
